...
public class PuntosHome {
	...
	public Puntos merge(Puntos detachedInstance) {
		...
		try {
			Puntos result = (Puntos) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Puntos findById(java.lang.Integer id) {
		log.debug("getting Puntos instance with id: " + id);
		try {
			Puntos instance = (Puntos) sessionFactory.getCurrentSession().get("Puntos", id);
			if (instance == null) {
	...
	public List findByExample(Puntos instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("Puntos").add(Example.create(instance))
					.list();
