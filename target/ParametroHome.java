...
public class ParametroHome {
	...
	public Parametro findById(java.lang.Integer id) {
		...
		try {
			Parametro instance = (Parametro) sessionFactory.getCurrentSession().get("Parametro", id);
			if (instance == null) {
	...
	public List findByExample(Parametro instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("Parametro").add(Example.create(instance))
					.list();
